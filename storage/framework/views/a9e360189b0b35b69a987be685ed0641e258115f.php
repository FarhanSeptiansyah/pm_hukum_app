        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_uu); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_perpu); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_pp); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_inpres); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_perma); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_sema); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_sk_kma); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
                        <i class="fa fa-file-text-o bounce"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_sk_sekma); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
                        <i class="fa fa-file-text-o pulse"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_se_dirjen); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
                        <i class="fa fa-file-text-o float"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_sk_dirjen); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
                        <i class="fa fa-file-text-o spin"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_se_kpta); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
                        <i class="fa fa-file-text-o shake"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_sk_kpta); ?>" data-decimal="," data-suffix="" data-duration="2.5">
                    <div class="xe-icon">
                        <i class="fa fa-file-text-o grow"></i>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="xe-widget xe-vertical-counter xe-vertical-counter-primary animated-widget" data-count=".num"
                    data-from="0" data-to="<?php echo e($jdih_peraturan_lainnya); ?>" data-decimal="," data-suffix=""
                    data-duration="2.5">
                    <div class="xe-icon">
...
<?php echo $__env->make('layouts.v_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\pm_hukum_app\resources\views//jdih/v_dashboard_jdih.blade.php ENDPATH**/ ?>